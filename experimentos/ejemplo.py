...
# fmt
COLS       = 'p_val,error,caso'         # header RESULTADOS
FMT_COLS   = "{0},{1},{2}\n"            # como se escribe a RESULTADOS
FMT_I      = DIR_IN  + "c{caso}.txt"        # como se llaman los archivos generados
FMT_name   = "x{x}_c{caso}"                 # idem
FMT_O      = DIR_OUT + FMT_name + ".out"    # idem
