...
\begin{figure}[!htbp]
    \centering
    \subfloat[av $\approx$ 0.91]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_31_0.91.png}}\hfill
    \subfloat[av $\approx$ 1.13]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_30_1.13.png}}\hfill
    \subfloat[av $\approx$ 1.26]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_29_1.26.png}}\hfill
    \subfloat[av $\approx$ 1.60]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_28_1.6.png}}\hfill
    \\[\smallskipamount]
    \subfloat[av $\approx$ 1.76]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_27_1.76.png}}\hfill
    \subfloat[av $\approx$ 1.83]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_26_1.83.png}}\hfill
    \subfloat[av $\approx$ 1.96]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_25_1.96.png}}\hfill
    \subfloat[av $\approx$ 2.00]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_24_2.0.png}}\hfill
    \\[\smallskipamount]
    \subfloat[av $\approx$ 2.00]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_23_2.0.png}}\hfill
    \subfloat[av $\approx$ 2.00]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_22_2.0.png}}\hfill
    \subfloat[av $\approx$ 2.00]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_21_2.0.png}}\hfill
    \subfloat[av $\approx$ 2.00]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_20_2.0.png}}\hfill
    \\[\smallskipamount]
    \subfloat[av $\approx$ 2.49]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_19_2.49.png}}\hfill
    \subfloat[av $\approx$ 2.75]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_18_2.75.png}}\hfill
    \subfloat[av $\approx$ 3.01]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_17_3.01.png}}\hfill
    \subfloat[av $\approx$ 3.24]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_16_3.24.png}}\hfill
\end{figure}

\begin{figure}[!htbp]
    \ContinuedFloat
    \centering
    \subfloat[av $\approx$ 3.38]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_15_3.38.png}}\hfill
    \subfloat[av $\approx$ 3.38]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_14_3.38.png}}\hfill
    \subfloat[av $\approx$ 3.47]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_13_3.47.png}}\hfill
    \subfloat[av $\approx$ 4.28]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_12_4.28.png}}\hfill
    \\[\smallskipamount]
    \subfloat[av $\approx$ 4.48]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_11_4.48.png}}\hfill
    \subfloat[av $\approx$ 4.58]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_10_4.58.png}}\hfill
    \subfloat[av $\approx$ 5.38]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_9_5.38.png}}\hfill
    \subfloat[av $\approx$ 5.62]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_8_5.62.png}}\hfill
    \\[\smallskipamount]
    \subfloat[av $\approx$ 6.33]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_7_6.33.png}}\hfill
    \subfloat[av $\approx$ 6.52]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_6_6.52.png}}\hfill
    \subfloat[av $\approx$ 7.0]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_5_7.0.png}}\hfill
    \subfloat[av $\approx$ 9.78]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_4_9.78.png}}\hfill
    \\[\smallskipamount]
    \subfloat[av $\approx$ 10.92]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_3_10.92.png}}\hfill
    \subfloat[av $\approx$ 13.31]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_2_13.31.png}}\hfill
    \subfloat[av $\approx$ 17.06]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_1_17.06.png}}\hfill
    \subfloat[av $\approx$ 18.14]{\includegraphics[width=.25\textwidth]{/files/src/.media/grafo_corte_0_18.14.png}}\hfill
    \\[\smallskipamount]
