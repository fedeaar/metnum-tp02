...
A su vez, presentaremos dos aplicaciones concretas de los autovalores y autovectores en el análisis de redes: la medición de centralidad de autovector y corte mínimo en la red del \textit{`Club de Karate'} \TODO{citar}, y la estimación de una \textit{ego-network} \TODO{citar} en Facebook, por medio de la construcción de una matriz de similaridad.  
